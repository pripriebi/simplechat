...
def lambda_handler(event, context):
    try:
        ...
        #ここから、Bedrockのレスポンスを受け取っている部分で、ここをFastAPIのレスポンスを受け取るように
        #ここコメントアウトでよいか？QQQ
        ...
        return {
            ...
            "body": json.dumps({
                "success": True,
                "response": assistant_response,#ここにFastAPIのレスポンスのメッセージを入れる
                "conversationHistory": messages## リクエストボディの解析
            })
        }
